<template>
  <nav class="bg-zinc-900 text-white fixed top-0 p-3 z-50 h-dvh md:p-5 md:z-0 md:sticky md:w-64 transform
    transition-all ease-in-out duration-500" :class="{ 'overflow-x-hidden -ml-64 p-0': !isOpen, 'w-64': isOpen }">
    <div class="flex flex-col gap-4 h-full">
      ...
      <div class="p-2 text-sm h-full">
        <u class="list-none no-underline flex flex-col justify-between gap-2 h-full">
            <div class="flex flex-col gap-2">
              ...
              <li class="flex items-center gap-3 font-semibold cursor-pointer hover:text-purple-400"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="flex items-center gap-3 font-semibold cursor-pointer hover:text-purple-400" @click="loggout">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
