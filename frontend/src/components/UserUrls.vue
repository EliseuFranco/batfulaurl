          ...
          <div class="flex items-center justify-between w-full ">
              <div class="w-full">
                  ...
                  <p class="text-zinc-300 mt-2 text-sm">Encurtada:</p>
                    <a :href="url.shortened_url" target="_blank" class="text-purple-500 break-all hover:underline">
                    {{ url.shortened_url }}
                    </a>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
               class="lucide lucide-copy-icon lucide-copy cursor-pointer">
...
const urls = ref([
  {
    original_url: 'https://www.exemplo.com/blog/post-completo-com-conteudo-interessante',
    shortened_url: 'https://curto.ly/abc123'
  },
  {
    original_url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    shortened_url: 'https://curto.ly/youtube99'
  },
  {
    original_url: 'https://www.nytimes.com/2025/01/15/tech/future-of-ai.html',
    shortened_url: 'https://curto.ly/nyt-ai'
  }
])
